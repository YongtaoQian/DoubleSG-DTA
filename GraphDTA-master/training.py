...
for dataset in datasets:
    ...
    if ((not os.path.isfile(processed_data_file_train)) or (not os.path.isfile(processed_data_file_test))):
        ...
        train_data = TestbedDataset(root='D:/研究生打工区/桌面文件/GraphDTA-master_2/GraphDTA-master/data', dataset=dataset + '_train')
        test_data = TestbedDataset(root='D:/研究生打工区/桌面文件/GraphDTA-master_2/GraphDTA-master/data', dataset=dataset + '_test')
        ...
        test_result_file = 'D:/研究生打工区/桌面文件/GraphDTA-master_2/GraphDTA-master/' + 'test_total_result_' + model_st + '_' + dataset + '.csv'
